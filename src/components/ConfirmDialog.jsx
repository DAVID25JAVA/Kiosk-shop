    ...
    <div className="fixed inset-0 bg-gray-900/40 backdrop-blur-sm flex items-center justify-center z-50 px-4">
      <div className="bg-white rounded-3xl shadow-2xl max-w-sm w-full p-8 relative">
        ...
        <div className="flex gap-3">
          <button
            onClick={onCancel}
            className="flex-1 py-3 cursor-pointer rounded-xl border border-gray-300 text-gray-600"
          >
            Go Back
          </button>
          ...
          <button
            onClick={onConfirm}
            className="flex-1 py-3 rounded-xl cursor-pointer outline-none  bg-indigo-500 text-white"
          >
            Submit
          </button>
        </div>
